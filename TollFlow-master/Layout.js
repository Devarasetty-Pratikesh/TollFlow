...
import { Car, BarChart3, Settings, Clock } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
        ...
        <Sidebar className="border-r border-slate-200 bg-white/80 backdrop-blur-md">
          <SidebarHeader className="border-b border-slate-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-slate-900 text-lg">TollFlow</h2>
                <p className="text-xs text-slate-500">Queue Management System</p>
              </div>
            </div>
          </SidebarHeader>
              ...
              <SidebarGroupContent>
                <div className="px-4 py-3 space-y-3">
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className="ml-auto font-semibold text-slate-900">2.5 min</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm">
          ...
          <SidebarFooter className="border-t border-slate-200 p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-slate-900 text-sm truncate">Toll Operator</p>
                <p className="text-xs text-slate-500 truncate">Managing traffic flow</p>
              </div>
            </div>
          </SidebarFooter>
        </Sidebar>
        ...
        <main className="flex-1 flex flex-col">
          <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 px-6 py-4 md:hidden">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-slate-900">TollFlow</h1>
            </div>
          </header>
